...
public class Registers {
    ...
    protected List<Object> summationOrCumDemandOrDemand;
    @XmlAttribute(name = "tier")
    @XmlSchemaType(name = "unsignedInt")
    protected Long tier;

    /**
     * Gets the value of the summationOrCumDemandOrDemand property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the summationOrCumDemandOrDemand property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSummationOrCumDemandOrDemand().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getSummationOrCumDemandOrDemand() {
        if (summationOrCumDemandOrDemand == null) {
            summationOrCumDemandOrDemand = new ArrayList<Object>();
        }
        return this.summationOrCumDemandOrDemand;
    }
