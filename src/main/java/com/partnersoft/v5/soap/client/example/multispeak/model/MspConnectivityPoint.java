...
@XmlType(name = "mspConnectivityPoint", propOrder = {
    "graphicSymbol",
    "annotationList",
    "sectionIDOrToNodeIDOrFromNodeID"
})
@XmlSeeAlso({
    ...
    extends MspPointObject
{
    ...
    protected List<JAXBElement<?>> sectionIDOrToNodeIDOrFromNodeID;
    ...
    /**
     * Gets the value of the sectionIDOrToNodeIDOrFromNodeID property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sectionIDOrToNodeIDOrFromNodeID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSectionIDOrToNodeIDOrFromNodeID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getSectionIDOrToNodeIDOrFromNodeID() {
        if (sectionIDOrToNodeIDOrFromNodeID == null) {
            sectionIDOrToNodeIDOrFromNodeID = new ArrayList<JAXBElement<?>>();
        }
        return this.sectionIDOrToNodeIDOrFromNodeID;
    }
