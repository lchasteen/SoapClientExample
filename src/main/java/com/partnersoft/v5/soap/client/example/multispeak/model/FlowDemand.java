 ...
 *       &lt;attribute name="flowDemandType" type="{http://www.multispeak.org/Version_3.0}flowDemandType" default="max" />
 *       &lt;attribute name="occurrence" type="{http://www.w3.org/2001/XMLSchema}unsignedByte" default="1" />
...
public class FlowDemand {
    ...
    public FlowDemandType getFlowDemandType() {
        if (flowDemandType == null) {
            return FlowDemandType.MAX;
        } else {
